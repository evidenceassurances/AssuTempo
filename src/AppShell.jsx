...
const ROUTE_TABLE = [
  ...
  ['/articles/assurance-auto-temporaire-1-mois', 'AssuranceTemporaire1Mois'],
  ...
  ['/assurance-temporaire-carte-grise-alfortville', 'VilleLocale'],
  ['/assurance-temporaire-carte-grise-creteil', 'VilleLocale'],
  ['/assurance-temporaire-carte-grise-vitry-sur-seine', 'VilleLocale'],
  ['/assurance-temporaire-carte-grise-ivry-sur-seine', 'VilleLocale'],
  ['/assurance-temporaire-carte-grise-maisons-alfort', 'VilleLocale'],
  ['/assurance-temporaire-carte-grise-charenton-le-pont', 'VilleLocale'],
  ['/cookies', 'Cookies'],
