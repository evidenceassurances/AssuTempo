...
/* Tuples partagés avec la Home via l'index léger (bundle critique) :
   toute la partie éditoriale ci-dessous reste dans le chunk de la Carte. */
/* (import hisse en tete de fichier) */
