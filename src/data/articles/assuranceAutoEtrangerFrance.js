...
export const articleData = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "La grande majorité des véhicules étrangers croisés sur les routes françaises entrent dans ce premier cas. Une assurance responsabilité civile souscrite en Allemagne, en Espagne, en Belgique ou dans tout autre État de l'UE ou de l'EEE couvre automatiquement la circulation en France : aucune formalité, aucun document à faire viser à la frontière.",
    ...
    },
    {
      ...
      paragraphs: [
        "Le système de la carte verte est un accord multilatéral entre bureaux nationaux d'assurance, antérieur à l'Union européenne et toujours en vigueur aujourd'hui. Un véhicule immatriculé au Maroc, en Turquie, au Royaume-Uni ou dans un autre pays membre peut circuler en France muni de la carte verte remise par son assureur d'origine, valable pour la durée qui y est indiquée.",
