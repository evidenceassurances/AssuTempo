const jsonLd = [
  {
    ...
    '@type': 'Article',
    headline: 'Carte grise urgente : certificat provisoire immédiat',
    description:
      "Besoin de rouler aujourd'hui ? Le certificat provisoire d'immatriculation s'obtient en ligne via un professionnel habilité, pendant que la carte grise arrive.",
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Articles', item: 'https://assutempo.fr/articles' },
      {
        '@type': 'ListItem',
        position: 3,
        name: 'Carte grise urgente : certificat provisoire immédiat',
        item: 'https://assutempo.fr/articles/carte-grise-urgence-cpi-immediat',
      },
    ],
  },
  {
    ...
    step: [
      {
        '@type': 'HowToStep',
        position: 1,
        name: 'T+0 : plaque et documents',
        text: "Certificat de cession ou ancienne carte grise, justificatif de domicile, pièce d'identité.",
      },
      {
        '@type': 'HowToStep',
        position: 2,
        name: 'T+10 min : dossier complété en ligne',
        text: 'CERFA préremplis à partir de la plaque, taxes calculées et réglables en plusieurs fois.',
      },
      {
        '@type': 'HowToStep',
        position: 3,
  ...
  },
  {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: "Combien de temps un certificat provisoire d'immatriculation reste-t-il valable ?",
        acceptedAnswer: {
          '@type': 'Answer',
          text: "1 mois, le temps que le certificat d'immatriculation définitif soit fabriqué et expédié.",
        },
      },
      {
        '@type': 'Question',
        name: 'Le certificat provisoire est-il valable à l\'étranger ?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Non, il autorise la circulation en France uniquement, en attendant le titre définitif.',
        },
      },
      {
        '@type': 'Question',
      ...
      {
        '@type': 'Question',
        name: 'Faut-il être assuré pour circuler avec un certificat provisoire ?',
        acceptedAnswer: {
          '@type': 'Answer',
...
export const articleData = {
  ...
  seo: {
    title: 'Carte grise urgente : certificat provisoire immédiat',
    description:
    ...
    canonical: 'https://assutempo.fr/articles/carte-grise-urgence-cpi-immediat',
    jsonLd,
  },
  ...
  sections: [
    ...
    },
    {
      ...
      steps: [
        {
          num: 1,
          title: 'T+0 : votre plaque et vos documents',
          body: "Certificat de cession ou ancienne carte grise, justificatif de domicile, pièce d'identité : le formulaire les demande en une fois.",
        },
        {
          num: 2,
          title: 'T+10 min : dossier complété en ligne',
          body: 'CERFA préremplis à partir de la plaque, taxes calculées et réglables en plusieurs fois.',
        },
        {
          num: 3,
    ...
    {
      type: 'checklist',
      heading: 'Quels documents avoir sous la main ?',
      intro: 'Pour un dossier accepté du premier coup, réunissez avant de commencer :',
      items: [
    ...
    {
      type: 'text',
      heading: "Pourquoi le circuit ANTS classique est-il plus lent ?",
      paragraphs: [
    ...
    {
      type: 'text',
      heading: 'Le certificat provisoire expire avant la réception de la carte grise : que faire ?',
      paragraphs: [
        "Le cas reste rare, mais il arrive quand la fabrication du titre définitif prend exceptionnellement plus d'un mois. Le réflexe n'est pas de rouler avec un CPI expiré : mieux vaut vérifier l'avancement du dossier sur l'espace ANTS et se rapprocher du professionnel habilité qui a monté la demande, plutôt que de prendre le risque d'un contrôle.",
      ],
    },
    {
      type: 'text',
    ...
    {
      type: 'text',
      heading: "Peut-on rouler à l'étranger avec un certificat provisoire ?",
      paragraphs: [
        "Non, pas dans le cas général : le CPI autorise la circulation en France uniquement, en attendant le certificat définitif. Un déplacement à l'étranger prévu avant sa réception se règle du côté de l'assurance, pas de la carte grise : une assurance temporaire couvre un véhicule dans 34 pays européens dès lors qu'il est légalement assurable, même avec une immatriculation encore provisoire.",
      ],
      relatedLink: {
    ...
    {
      type: 'text',
      heading: "Peut-on faire cette démarche un soir ou un week-end ?",
      paragraphs: [
        "Oui pour la partie en ligne : saisie du dossier, calcul des taxes et paiement se font à toute heure, depuis un téléphone ou un ordinateur. Le traitement du dossier par le service instructeur, lui, suit des horaires ouvrés classiques. La différence se joue donc surtout en amont, sur la rapidité à constituer un dossier complet et exploitable dès son dépôt.",
      ],
    },
    {
      type: 'text',
      heading: 'Quels véhicules sont concernés par le certificat provisoire ?',
      paragraphs: [
        "Le principe s'applique à tout véhicule soumis au système d'immatriculation (SIV) : voiture particulière, utilitaire léger, camping-car ou moto acheté neuf ou d'occasion, en France comme importé d'un autre pays européen. Un véhicule importé demande en général une pièce supplémentaire (le certificat de conformité), mais le circuit reste le même : dossier en ligne, certificat provisoire, puis titre définitif.",
      ],
    },
    {
      type: 'text',
      heading: "Et l'assurance, pendant ces démarches ?",
      paragraphs: [
        "Le CPI ne dispense jamais d'assurance. La responsabilité civile reste obligatoire dès le premier trajet, véhicule fraîchement acheté ou certificat provisoire en cours de validité. Si le contrat annuel n'est pas encore en place, une assurance temporaire AssuTempo (assutempo.fr) délivre une attestation par email en 5 minutes, sans attendre que la carte grise soit à votre nom.",
      ],
      relatedLink: {
  ...
  faqItems: [
    {
      q: "Combien de temps un certificat provisoire d'immatriculation reste-t-il valable ?",
      a: "1 mois, le temps que le certificat d'immatriculation définitif soit fabriqué et expédié.",
    },
    {
      q: "Le certificat provisoire est-il valable à l'étranger ?",
      a: 'Non, il autorise la circulation en France uniquement, en attendant le titre définitif.',
    },
    {
