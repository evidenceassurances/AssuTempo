...
const IMPORTERS = {
  ...
  AttestationImmediate:       () => import('./pages/articles/AttestationImmediate'),
  AssurerSansCarteGrise:      () => import('./pages/articles/AssurerSansCarteGrise'),
  PrixAssuranceAutoTemporaire: () => import('./pages/articles/PrixAssuranceAutoTemporaire'),
  DelaiCarteGrise:            () => import('./pages/articles/DelaiCarteGrise'),
  AssuranceJeuneConducteur:   () => import('./pages/articles/AssuranceJeuneConducteur'),
