...
const faqs = [
  {
    ...
    link: { to: '/tarification', label: 'Voir le tarif en ligne' },
  },
  {
    ...
    link: { to: '/articles', label: 'Voir tous les cas concrets' },
  },
  {
    ...
    link: { to: '/articles/assurance-auto-temporaire-jeune-conducteur', label: 'La règle jeune conducteur en détail' },
  },
  {
    ...
    link: { to: '/tarification', label: 'Obtenir mon devis' },
  },
  {
  ...
  },
  {
    ...
    link: { to: '/articles/assurer-voiture-sans-carte-grise', label: 'Assurer sans carte grise à votre nom' },
  },
  {
    ...
    link: { to: '/conditions-generales', label: 'Lire les conditions générales' },
  },
  {
  ...
  },
  {
    ...
    link: { to: '/articles/assurance-temporaire-attestation-immediate', label: "Comprendre l'attestation immédiate" },
  },
  {
    q: "Quelle est la durée maximum d'assurance ?",
    a: "De 1 à 90 jours, au jour près, avec possibilité de renouvellement.",
    link: { to: '/articles/assurance-auto-temporaire-1-mois', label: '1 semaine ou 1 mois : que choisir ?' },
  },
  {
    ...
    link: { to: '/qui-sommes-nous', label: 'Nous contacter' },
  },
  {
  ...
  },
  {
    ...
    link: { to: '/carte', label: 'Voir la carte des 34 pays' },
  },
  {
    ...
    link: { to: '/guichet-de-nuit', label: 'Déposer ma demande au Guichet de Nuit' },
  },
  {
    ...
    link: { to: '/articles/combien-de-jours-assurance-sortir-fourriere', label: 'Le guide complet sortie de fourrière' },
  },
];
