...
const ROUTES = [
  ...
  '/assurance-temporaire-carte-grise-alfortville',
  '/assurance-temporaire-carte-grise-creteil',
  '/assurance-temporaire-carte-grise-vitry-sur-seine',
  '/assurance-temporaire-carte-grise-ivry-sur-seine',
  '/assurance-temporaire-carte-grise-maisons-alfort',
  '/assurance-temporaire-carte-grise-charenton-le-pont',
  '/cookies',
...
const ROUTE_MODULES = {
  ...
  '/avis-et-garanties':       'src/pages/AvisEtGaranties.jsx',
  ...
  '/assurance-temporaire-carte-grise-alfortville':      'src/pages/VilleLocale.jsx',
  '/assurance-temporaire-carte-grise-creteil':          'src/pages/VilleLocale.jsx',
  '/assurance-temporaire-carte-grise-vitry-sur-seine':  'src/pages/VilleLocale.jsx',
  '/assurance-temporaire-carte-grise-ivry-sur-seine':   'src/pages/VilleLocale.jsx',
  '/assurance-temporaire-carte-grise-maisons-alfort':   'src/pages/VilleLocale.jsx',
  '/assurance-temporaire-carte-grise-charenton-le-pont': 'src/pages/VilleLocale.jsx',
