...
import{a as e,n as t}from"./rolldown-runtime-Cyuzqnbw.js";import{A as n,j as r}from"./framer-Be3hPn0e.js";import{c as i,f as a,h as o,l as s,p as c,t as ee}from"./react-vendor-CwaN-pok.js";import{o as l,s as te}from"./index-LMShOlVP.js";var ne,u=t((()=>{ne=`
.atp-root {
  --atp-gold: #C9A84C;
...
`})),d,f=t((()=>{d={temporaire:{label:`Assurance temporaire`,sub:`Devis et souscription en ligne`,icon:`shield`,mobile:{message:`Renseignez votre véhicule, la durée (1 à 90 jours) et vos informations dans le formulaire ; l'attestation arrive en quelques minutes, sans relevé d'information. Je vous y emmène.`,ctaLabel:`Aller au formulaire`,path:`/tarification`,scrollTarget:`[data-assistant-target="tarif-iframe"]`},steps:[{target:`[data-assistant-target="devis"]`,title:`Tout commence ici`,text:`Pour lancer votre assurance temporaire, cliquez sur « Obtenir mon devis ». Ce bouton est disponible sur chaque page. Je vous emmène au formulaire.`,placement:`bottom`},{path:`/tarification`,target:`[data-assistant-target="tarif-iframe"]`,title:`Votre formulaire sécurisé`,text:`Voici votre formulaire. Renseignez-y le véhicule, la durée (de 1 à 90 jours) et vos informations. L'attestation arrive en quelques minutes, sans relevé d'information.`,placement:`top`,frame:!0}]},"carte-grise":{label:`Carte grise`,sub:`Immatriculation en ligne`,icon:`file`,mobile:{message:`Votre demande passe par notre partenaire Certimat. Renseignez votre véhicule dans le module sécurisé pour obtenir votre carte grise. Je vous y emmène.`,ctaLabel:`Accéder à la carte grise`,path:`/carte-grise`,scrollTarget:`[data-assistant-target="carte-grise-iframe"]`},steps:[{path:`/carte-grise`,target:`[data-assistant-target="carte-grise-iframe"]`,title:`Votre demande de carte grise`,text:`Voici le module sécurisé, propulsé par notre partenaire Certimat. Renseignez-y votre véhicule pour obtenir votre carte grise.`,placement:`top`,frame:!0}]}}})),p,m,h,re=t((()=>{p={navLinks:[{label:`Tarification`,href:`/tarification`},{label:`FAQ`,href:`/faq`},{label:`Carte`,href:`/carte`},{label:`Qui sommes-nous ?`,href:`/qui-sommes-nous`}],hero:{badge:`ASSURANCE TEMPORAIRE EN LIGNE`,title:`Votre assurance temporaire en 2 clics`,subtitle:`De 1 à 90 jours • Sans relevé d'information • Attestation immédiate`,primaryCta:{label:`Voir nos tarifs`,href:`/tarification`},secondaryCta:{label:`En savoir plus`,href:`/qui-sommes-nous`},trust:[{label:`Certifié sans surprise`,icon:`Check`},{label:`34 pays`,icon:`Globe`},{label:`Attestation immédiate`,icon:`Zap`}]},stats:[{label:`ANS D'EXPÉRIENCE`,value:6,suffix:``},{label:`MIN DE SOUSCRIPTION`,value:5,prefix:`<`},{label:`PAYS COUVERTS`,value:34},{label:`JOURS`,value:60,prefix:`1→`}],benefits:[{icon:`Target`,title:`Certifié sans surprise`,description:`Prix fixe à l'euro près. Pas de petite ligne, pas de frais cachés.`},{icon:`Globe`,title:`Assistance Europe`,description:`Couverture dans 34 pays européens dès le premier jour du contrat.`},{icon:`Zap`,title:`Illico Presto`,description:`Souscription en moins de 5 minutes. Attestation disponible immédiatement.`}],whyItems:[`Vous venez d’acquérir un véhicule et souhaitez l’assurer immédiatement`,`Démarche de carte grise à effectuer rapidement`,`Permis ou véhicule étranger`,`Véhicule qui circule peu dans l’année`,`Véhicule en transit en France ou à l’étranger`,`Export de véhicule`],contact:{title:`Besoin d’assistance ?`,phone:`09 74 19 78 20`,hours:[`Lundi - Vendredi : 9h00 - 21h00`,`Samedi : 9h00 - 20h00`],cta:{label:`Souscrire maintenant`,href:`/tarification`},note:`Portail accessible 24h/24 - 7j/7`},pricingPlans:[{name:`Éclair`,price:`39€`,description:`Assurance temporaire ultra-rapide pour moins de 7 jours.`,features:[`Attestation immédiate`,`Assistance Europe`,`Sans relevé d’information`]},{name:`Zen`,price:`59€`,description:`Couverture flexible de 1 à 30 jours, idéale pour carte grise.`,features:[`Prix clair`,`Support dédié`,`Paiement sécurisé`]},{name:`Pro`,price:`79€`,description:`Formule 90 jours avec assistance étendue et suivi personnalisé.`,features:[`Accompagnement 24/7`,`Sans surprise`,`Renouvelable`]}],faqItems:[{question:`Qu’est-ce qu’une assurance temporaire ?`,answer:`Une assurance auto temporaire est une couverture de courte durée, de 1 à 90 jours, avec validité immédiate et sans relevé d’information.`},{question:`Pourquoi souscrire une assurance temporaire ?`,answer:`Pour l’achat, l’export, la carte grise, le véhicule étranger ou un besoin ponctuel sans engagement long terme.`},{question:`Puis-je souscrire ?`,answer:`Oui, si vous avez 20 ans ou plus et un permis depuis au moins 2 ans. Certaines restrictions s’appliquent si vous avez des sinistres ou résiliations récentes.`},{question:`Que contient ma couverture ?`,answer:`Responsabilité civile, défense recours et assistance dépannage en France et en Europe selon les conditions du contrat.`},{question:`Suis-je couvert contre le vol ?`,answer:`Non, la couverture temporaire concerne la responsabilité civile, la défense recours et l’assistance.`},{question:`Suis-je couvert contre le bris de glace ?`,answer:`Non, cette protection n’est pas incluse dans la formule temporaire standard.`},{question:`Documents nécessaires ?`,answer:`Permis de conduire, carte grise du véhicule et carte bancaire pour le paiement en ligne.`},{question:`Puis-je me rétracter ?`,answer:`Non, les contrats d’assurance temporaire ne sont pas soumis au droit de rétractation une fois le contrat activé.`}]},p.navLinks,p.faqItems,p.pricingPlans,m=[`/tarification`],h=(e=``)=>{let t=String(e).toLowerCase().split(`?`)[0].replace(/\/+$/,``)||`/`;return m.includes(t)}}));function ie(e){return String(e||``).toLowerCase().replace(/[^\p{L}\p{N}\s]/gu,` `).replace(/\s+/g,` `).trim()}function ae(e){let t=String(e||``);return t=t.replace(/^\s{0,3}#{1,6}\s+/gm,``),t=t.replace(/^\s{0,3}[-*+]\s+/gm,``),t=t.replace(/\*\*([^*]+)\*\*/g,`$1`),t=t.replace(/__([^_]+)__/g,`$1`),t=t.replace(/\*([^*]+)\*/g,`$1`),t=t.replace(/_([^_]+)_/g,`$1`),t=t.replace(/`+/g,``),t=t.replace(/\*+/g,``),t=t.replace(/[ \t]{2,}/g,` `),t=t.replace(/\n{3,}/g,`

`),t.trim()}function oe(e){return/\[fin\]/i.test(String(e||``))}function se(e){return ae(String(e||``).replace(/\[fin\]/gi,``))}function g({name:e,size:t=18}){let n={width:t,height:t,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:1.8,strokeLinecap:`round`,strokeLinejoin:`round`,"aria-hidden":!0};switch(e){case`close`:return(0,b.jsx)(`svg`,{...n,children:(0,b.jsx)(`path`,{d:`M18 6 6 18M6 6l12 12`})});case`send`:return(0,b.jsx)(`svg`,{...n,children:(0,b.jsx)(`path`,{d:`M22 2 11 13M22 2l-7 20-4-9-9-4 20-7z`})});case`restart`:return(0,b.jsxs)(`svg`,{...n,children:[(0,b.jsx)(`path`,{d:`M3 12a9 9 0 1 0 3-6.7L3 8`}),(0,b.jsx)(`path`,{d:`M3 3v5h5`})]});case`shield`:return(0,b.jsx)(`svg`,{...n,children:(0,b.jsx)(`path`,{d:`M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z`})});case`file`:return(0,b.jsxs)(`svg`,{...n,children:[(0,b.jsx)(`path`,{d:`M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z`}),(0,b.jsx)(`path`,{d:`M14 2v6h6`})]});case`globe`:return(0,b.jsxs)(`svg`,{...n,children:[(0,b.jsx)(`circle`,{cx:`12`,cy:`12`,r:`10`}),(0,b.jsx)(`path`,{d:`M2 12h20M12 2a15 15 0 0 1 0 20a15 15 0 0 1 0-20z`})]});case`chevron-down`:return(0,b.jsx)(`svg`,{...n,children:(0,b.jsx)(`path`,{d:`m6 9 6 6 6-6`})});case`bubble`:return(0,b.jsx)(`svg`,{...n,children:(0,b.jsx)(`path`,{d:`M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z`})});default:return null}}function ce(e){return Array.from({length:e},()=>({top:(Math.random()*100).toFixed(2),left:(Math.random()*100).toFixed(2),size:(1.4+Math.random()*1.8).toFixed(2),delay:(Math.random()*4).toFixed(2),dur:(2.6+Math.random()*2.6).toFixed(2)}))}function le({field:e}){return(0,b.jsx)(`div`,{className:`atp-stars`,"aria-hidden":!0,children:e.map((e,t)=>(0,b.jsx)(`span`,{className:`atp-star`,style:{top:e.top+`%`,left:e.left+`%`,width:e.size+`px`,height:e.size+`px`,animationDelay:e.delay+`s`,animationDuration:e.dur+`s`}},t))})}function ue(){return(0,b.jsxs)(`span`,{className:`atp-sigil`,"aria-hidden":!0,children:[(0,b.jsx)(`span`,{className:`atp-sigil-ring`}),(0,b.jsx)(`span`,{className:`atp-sigil-orbit`,children:(0,b.jsx)(`span`,{className:`atp-sigil-particle`})}),(0,b.jsx)(`span`,{className:`atp-sigil-core`})]})}function de(e,{large:t,reduced:n}){if(!e||typeof window>`u`)return;let r=e.getBoundingClientRect(),i=window.scrollY+r.top,a=window.innerHeight,o;o=t?T:Math.max(104,(a-r.height)/2);let s=Math.max(0,i-o);window.scrollTo({top:s,behavior:n?`auto`:`smooth`})}function fe(){try{return typeof window<`u`&&!!localStorage.getItem(E)}catch{return!0}}function _(){if(typeof window>`u`)return!1;let e=window.innerWidth<=820,t=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches;return e||t}function pe(e,t=3500){return new Promise(n=>{let r=Date.now();(function i(){let a=document.querySelector(e);if(a)return n(a);if(Date.now()-r>t)return n(null);setTimeout(i,80)})()})}function me(e,t=[]){let n=new Map;for(let r of t){let t=Math.min(r.rang,e.length);n.has(t)||n.set(t,[]),n.get(t).push(`[Action] Le visiteur a cliqué sur "`+r.label+`"`)}let r=[];for(let t=0;t<e.length;t++)n.has(t)&&r.push(...n.get(t)),r.push((e[t].role===`user`?`Visiteur`:`Tempo`)+` : `+e[t].content);return n.has(e.length)&&r.push(...n.get(e.length)),r.join(`

`)}function he(e,t){if(typeof window>`u`)return;let n=new FormData;n.append(`access_key`,D),n.append(`subject`,`Conversation assistant Tempo (assutempo.fr)`),n.append(`from_name`,`Assistant Tempo`),n.append(`page`,window.location.pathname||`/`),n.append(`date`,new Date().toLocaleString(`fr-FR`)),n.append(`message`,me(e,t));try{navigator.sendBeacon?navigator.sendBeacon(O,n):fetch(O,{method:`POST`,body:n,keepalive:!0}).catch(()=>{})}catch{}}function v(){let[e,t]=(0,y.useState)(!1),[n,r]=(0,y.useState)(!1),[o,c]=(0,y.useState)(!1),[ee,l]=(0,y.useState)(!1),[u,f]=(0,y.useState)([{role:`assistant`,content:ye}]),[p,m]=(0,y.useState)(``),[h,re]=(0,y.useState)(!1),[ae,ce]=(0,y.useState)(!1),[me,v]=(0,y.useState)(!1),[x,S]=(0,y.useState)(!1),[C,E]=(0,y.useState)(!1),[D,O]=(0,y.useState)(!1),[k,A]=(0,y.useState)(null),[Ee,De]=(0,y.useState)(()=>!fe()),[Oe,j]=(0,y.useState)(!1),[ke,Ae]=(0,y.useState)(!1),[je,Me]=(0,y.useState)(!1),[M,N]=(0,y.useState)({active:!1,flowKey:null,step:0}),[P,F]=(0,y.useState)(null),I=s(),Ne=i(),L=(0,y.useRef)(Ne.pathname);L.current=Ne.pathname;let R=(0,y.useRef)(!1),z=(0,y.useRef)(null),B=(0,y.useRef)(null),V=(0,y.useRef)(!1),H=(0,y.useRef)(null),Pe=(0,y.useRef)(null),Fe=(0,y.useRef)(null),Ie=(0,y.useRef)(!1),U=(0,y.useRef)(null);U.current===null&&(U.current=new Set);let Le=(0,y.useRef)(!1),W=(0,y.useRef)(0),Re=(0,y.useRef)(0),[G,ze]=(0,y.useState)(null),Be=typeof window<`u`&&/[?&]perfdebug/.test(window.location.search),Ve=(0,y.useRef)(u),He=(0,y.useRef)([]),Ue=(0,y.useRef)(0);(0,y.useEffect)(()=>{Ve.current=u},[u]);let K=(0,y.useCallback)(e=>{He.current.push({rang:(Ve.current||[]).length,label:e})},[]),q=(0,y.useCallback)(()=>{let e=Ve.current||[],t=He.current||[],n=e.filter(e=>e.role===`user`).length+t.length;n===0||n<=Ue.current||(he(e,t),Ue.current=n)},[]);(0,y.useEffect)(()=>{let e=()=>q(),t=()=>{document.visibilityState===`hidden`&&q()};return window.addEventListener(`pagehide`,e),document.addEventListener(`visibilitychange`,t),()=>{window.removeEventListener(`pagehide`,e),document.removeEventListener(`visibilitychange`,t)}},[q]),(0,y.useEffect)(()=>{if(t(!0),typeof document<`u`&&!document.getElementById(ve)){let e=document.createElement(`style`);e.id=ve,e.textContent=ne,document.head.appendChild(e)}typeof window<`u`&&window.matchMedia&&(R.current=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches)},[]),(0,y.useEffect)(()=>{if(_())return;let e,t=()=>{a(()=>import(`./CosmosCanvas-CMbUEmbF.js`),__vite__mapDeps([0,1,2]))};return typeof window<`u`&&window.requestIdleCallback?(e=window.requestIdleCallback(t),()=>window.cancelIdleCallback&&window.cancelIdleCallback(e)):(e=setTimeout(t,1200),()=>clearTimeout(e))},[]),(0,y.useLayoutEffect)(()=>{o&&W.current&&(Re.current=performance.now())},[o]),(0,y.useEffect)(()=>{if(!o||!W.current)return;let e=W.current,t=Re.current||e,n=0,r=requestAnimationFrame(()=>{n=requestAnimationFrame(()=>{let n=performance.now();ze({render:Math.round(t-e),paint:Math.round(n-t),total:Math.round(n-e)}),W.current=0})});return()=>{cancelAnimationFrame(r),n&&cancelAnimationFrame(n)}},[o]),(0,y.useEffect)(()=>{let e=()=>{l(!1),c(!0)};return typeof window<`u`&&window.__assutempoOpenPending&&(delete window.__assutempoOpenPending,e()),window.addEventListener(`assutempo:open-assistant`,e),()=>window.removeEventListener(`assutempo:open-assistant`,e)},[]),(0,y.useEffect)(()=>{De(!fe());let e=()=>De(!1),t=()=>De(!0);return window.addEventListener(`cookie-consent`,e),window.addEventListener(`open-cookie-settings`,t),()=>{window.removeEventListener(`cookie-consent`,e),window.removeEventListener(`open-cookie-settings`,t)}},[]);let J=!o&&!M.active&&!Ee;(0,y.useEffect)(()=>{if(!J){j(!1);return}let e=!1,t=0,n=0,r=0,i=()=>{clearTimeout(r),r=setTimeout(o,3e4)},a=()=>{e=!1,j(!1),i()};function o(){e=!0,j(!0),clearTimeout(n),n=setTimeout(a,5e3)}let s=()=>{e||i()};Ie.current?(j(!1),i()):t=setTimeout(()=>{Ie.current=!0,o()},1500);let c=[`pointerdown`,`keydown`,`wheel`,`touchstart`];return c.forEach(e=>window.addEventListener(e,s,{passive:!0})),window.addEventListener(`scroll`,s,{passive:!0}),()=>{clearTimeout(t),clearTimeout(n),clearTimeout(r),c.forEach(e=>window.removeEventListener(e,s)),window.removeEventListener(`scroll`,s)}},[J,Ne.pathname]),(0,y.useEffect)(()=>{let e=e=>Me(!!(e.detail&&e.detail.dragging));return window.addEventListener(`assutempo:instrument-drag`,e),()=>window.removeEventListener(`assutempo:instrument-drag`,e)},[]),(0,y.useEffect)(()=>{if(!J){Ae(!1);return}let e=0,t=(e,t)=>e<0||t<0||e>window.innerWidth||t>window.innerHeight?!1:document.elementsFromPoint(e,t).some(e=>e.closest&&e.closest(`.btn-gold, .btn-glass`)),n=()=>{let e=Pe.current;if(!e)return;let n=e.getBoundingClientRect(),r=[[n.left+n.width/2,n.top+n.height/2],[n.left+6,n.top+6],[n.right-6,n.top+6],[n.left+6,n.bottom-6],[n.right-6,n.bottom-6]],i=Fe.current;if(i&&Oe){let e=i.getBoundingClientRect();r.push([e.left+4,e.top+e.height/2],[e.left+e.width/2,e.top+e.height/2])}Ae(r.some(([e,n])=>t(e,n)))},r=0,i=0,a=()=>{e=0,r=performance.now(),n()},o=()=>{let t=200-(performance.now()-r);t<=0?e||=requestAnimationFrame(a):i||=setTimeout(()=>{i=0,o()},t)};return window.addEventListener(`scroll`,o,{passive:!0}),window.addEventListener(`resize`,o),o(),()=>{e&&cancelAnimationFrame(e),clearTimeout(i),window.removeEventListener(`scroll`,o),window.removeEventListener(`resize`,o)}},[J,Oe]),(0,y.useEffect)(()=>{let e=()=>r(_());e();let t=typeof window<`u`&&window.matchMedia?window.matchMedia(`(pointer: coarse)`):null;return window.addEventListener(`resize`,e,{passive:!0}),t&&t.addEventListener&&t.addEventListener(`change`,e),()=>{window.removeEventListener(`resize`,e),t&&t.removeEventListener&&t.removeEventListener(`change`,e)}},[]),(0,y.useEffect)(()=>{z.current&&(z.current.scrollTop=z.current.scrollHeight)},[u,h,me]),(0,y.useEffect)(()=>{if(o&&!M.active&&!n&&B.current){let e=setTimeout(()=>B.current&&B.current.focus(),250);return()=>clearTimeout(e)}},[o,M.active,n]),(0,y.useEffect)(()=>{if(!o&&!M.active)return;let e=e=>{e.key===`Escape`&&(M.active?Z(!1):X())};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[o,M.active]);let We=(0,y.useCallback)(()=>{Le.current||(Le.current=!0,O(!0),f(e=>[...e,{role:`assistant`,content:Ce(L.current)}]))},[]),Ge=(0,y.useCallback)(async e=>{let t=(e||``).trim();if(!t||h||D)return;let n=u.filter(e=>e.role===`user`).length;if(n>=w){We();return}let r=ie(t);if(r&&U.current.has(r)){f(e=>[...e,{role:`user`,content:t},{role:`assistant`,content:Se(L.current)}]),m(``),v(!1),A(null);return}r&&U.current.add(r);let i=[...u,{role:`user`,content:t}];f(i),m(``),v(!1),A(null),re(!0),E(!0),setTimeout(()=>E(!1),600);try{let e=i.filter(e=>e.role===`user`||e.role===`assistant`).map(e=>({role:e.role,content:e.content})),t=await fetch(`/api/chat`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify({messages:e,page:L.current})});if(!t.ok||!t.body)throw Error(`http`);let r=t.body.getReader(),a=new TextDecoder,o=``,s=``,c=()=>{let e=se(s);V.current?f(t=>{let n=t.slice();return n[n.length-1]={role:`assistant`,content:e},n}):(V.current=!0,ce(!0),f(t=>[...t,{role:`assistant`,content:e}]))};for(;;){let{done:e,value:t}=await r.read();if(e)break;o+=a.decode(t,{stream:!0});let n=o.split(`

`);o=n.pop()||``;for(let e of n){let t=e.split(`
`).find(e=>e.startsWith(`data:`));if(!t)continue;let n;try{n=JSON.parse(t.slice(5).trim())}catch{continue}if(n.error)throw Error(`upstream`);typeof n.t==`string`&&n.t&&(s+=n.t,c())}}if(!s.trim())throw Error(`empty`);(oe(s)||n+1>=w)&&We()}catch{f(e=>{let t=V.current?e.slice(0,-1):e.slice();return t.push({role:`assistant`,content:be(L.current)}),t})}finally{V.current=!1,ce(!1),re(!1),S(!0)}},[u,h,D,We]);function Y(){o||(W.current||=performance.now(),l(!1),c(!0))}function X(e=!0){e&&q(),l(!0),setTimeout(()=>{c(!1),l(!1)},R.current?0:280)}function Ke(e){m(e.target.value);let t=e.target;t.style.height=`auto`,t.style.height=Math.min(t.scrollHeight,96)+`px`}function qe(e){e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),Ge(p),B.current&&(B.current.style.height=`auto`))}let Je=(0,y.useCallback)(e=>{if(!e)return;let t=e.getBoundingClientRect();F({top:t.top-8,left:t.left-8,width:t.width+16,height:t.height+16})},[]);function Ye(e){let t=d[e];!t||!t.mobile||(v(!1),f(e=>[...e,{role:`assistant`,content:t.mobile.message}]),A({ctaLabel:t.mobile.ctaLabel,path:t.mobile.path,scrollTarget:t.mobile.scrollTarget}))}function Xe(e){if(v(!1),_()){Ye(e);return}d[e]&&(X(!1),H.current=null,F(null),N({active:!0,flowKey:e,step:0}))}function Ze(e){A(null),X(!1);let t=R.current?`auto`:`smooth`,n=e=>{e&&pe(e,3500).then(e=>{e&&e.scrollIntoView({behavior:t,block:`start`})})};e.path&&window.location.pathname!==e.path?(I(e.path),setTimeout(()=>n(e.scrollTarget),R.current?60:360)):n(e.scrollTarget)}function Z(e){N({active:!1,flowKey:null,step:0}),F(null),H.current=null,Y(),e&&f(e=>[...e,{role:`assistant`,content:`Et voilà, vous êtes au bon endroit. Je reste disponible si vous avez la moindre question pendant votre démarche.`}])}function Qe(){let e=d[M.flowKey];if(!e)return Z(!1);if(M.step>=e.steps.length-1)return Z(!0);H.current=null,F(null),N(e=>({...e,step:e.step+1}))}function $e(){M.step<=0||(H.current=null,F(null),N(e=>({...e,step:e.step-1})))}if((0,y.useEffect)(()=>{if(!M.active||_())return;let e=d[M.flowKey],t=e&&e.steps[M.step];if(!t)return;let n=!1;return(async()=>{if(t.path&&window.location.pathname!==t.path&&(I(t.path),await Te(R.current?60:360)),n)return;if(!t.target){H.current=null,F(null);return}let e=await pe(t.target,3500);if(n)return;if(!e){H.current=null,F(null);return}if(n)return;H.current=e,Je(e);let r=()=>de(e,{large:!!t.frame,reduced:R.current});r(),t.frame&&[120,360,760,1300].forEach(t=>setTimeout(()=>{if(n||H.current!==e)return;let t=e.getBoundingClientRect().top;Math.abs(t-T)>24&&r()},t))})(),()=>{n=!0}},[M.active,M.flowKey,M.step,I,Je]),(0,y.useEffect)(()=>{if(!M.active||_())return;let e=0,t=null,n=()=>{let r=H.current;if(r){let e=r.getBoundingClientRect(),n={top:e.top-8,left:e.left-8,width:e.width+16,height:e.height+16};(!t||Math.abs(n.top-t.top)>.5||Math.abs(n.left-t.left)>.5||Math.abs(n.width-t.width)>.5||Math.abs(n.height-t.height)>.5)&&(t=n,F(n))}e=requestAnimationFrame(n)};return e=requestAnimationFrame(n),()=>cancelAnimationFrame(e)},[M.active,M.step]),!e)return null;let Q=M.active?d[M.flowKey]:null,$=Q?Q.steps[M.step]:null;function et(){if(n||_()||!M.active||!$)return null;let e=window.innerWidth,t=window.innerHeight,r=!!$.frame,i;if(r&&P){let n=Math.min(Math.max(P.top,16),t-240);i=e-(P.left+P.width)>=P.left?{right:16,top:n}:{left:16,top:n}}else if(!P)i={top:`50%`,left:`50%`,transform:`translate(-50%, -50%)`};else{let n=$.placement===`top`||$.placement!==`bottom`&&P.top>t*.55,r=Math.min(Math.max(P.left,16),e-Math.min(330,e-32)-16);i=n?{bottom:t-P.top+16,left:r}:{top:P.top+P.height+16,left:r}}return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(`div`,{className:`atp-tour-veil`+(r?` atp-tour-veil--frame`:P?``:` atp-tour-veil--nospot`)}),P&&!r&&(0,b.jsx)(`div`,{className:`atp-tour-spot`,style:{top:P.top,left:P.left,width:P.width,height:P.height}}),P&&r&&(0,b.jsx)(`div`,{className:`atp-tour-frame`,style:{transform:`translate(${P.left}px, ${P.top}px)`,width:P.width,height:P.height}}),P&&!r&&(0,b.jsx)(`div`,{className:`atp-tour-pointer`,style:{top:Math.max(P.top-30,6),left:P.left+P.width/2-11},children:(0,b.jsx)(g,{name:`chevron-down`,size:22})}),(0,b.jsx)(`button`,{type:`button`,className:`atp-tour-close`,"aria-label":`Quitter le guide`,onClick:()=>Z(!1),children:(0,b.jsx)(g,{name:`close`,size:18})}),(0,b.jsxs)(`div`,{className:`atp-tooltip`,style:i||void 0,role:`dialog`,"aria-label":`Étape du guide`,children:[(0,b.jsx)(le,{field:we}),(0,b.jsxs)(`div`,{className:`atp-tooltip-step`,children:[Q.label,` · Étape `,M.step+1,` / `,Q.steps.length]}),(0,b.jsx)(`h3`,{className:`atp-tooltip-title atp-serif`,children:$.title}),(0,b.jsx)(`p`,{className:`atp-tooltip-text`,children:$.text}),(0,b.jsxs)(`div`,{className:`atp-tooltip-foot`,children:[(0,b.jsx)(`div`,{className:`atp-progress`,"aria-hidden":!0,children:Q.steps.map((e,t)=>(0,b.jsx)(`span`,{className:`atp-progress-dot`+(t<=M.step?` atp-progress-dot--on`:``)},t))}),M.step>0&&(0,b.jsx)(`button`,{type:`button`,className:`atp-tour-btn atp-tour-btn--ghost`,onClick:$e,children:`Précédent`}),(0,b.jsx)(`button`,{type:`button`,className:`atp-tour-btn atp-tour-btn--solid`,onClick:Qe,children:M.step>=Q.steps.length-1?`Terminer`:`Suivant`})]})]})]})}function tt(){K(`Obtenir mon devis`),te(`cta_devis_click`,{cta_label:`Obtenir mon devis`,page_path:window.location.pathname}),window.location.pathname!==`/tarification`&&I(`/tarification`),X()}function nt(){if(D)return(0,b.jsx)(`div`,{className:`atp-actions`,style:{flexDirection:`column`},children:(0,b.jsx)(`button`,{type:`button`,className:`atp-cta`,onClick:tt,children:`Obtenir mon devis`})});if(k)return(0,b.jsx)(`div`,{className:`atp-actions`,style:{flexDirection:`column`},children:(0,b.jsx)(`button`,{type:`button`,className:`atp-cta`,onClick:()=>{K(k.ctaLabel),Ze(k)},children:k.ctaLabel})});if(me){let e=n?Ye:Xe;return(0,b.jsx)(`div`,{className:`atp-actions`,style:{flexDirection:`column`},children:Object.entries(d).map(([t,n])=>(0,b.jsxs)(`button`,{type:`button`,className:`atp-flow`,onClick:()=>{K(n.label),e(t)},children:[(0,b.jsx)(`span`,{className:`atp-flow-icon`,children:(0,b.jsx)(g,{name:n.icon,size:20})}),(0,b.jsxs)(`span`,{className:`atp-flow-text`,children:[(0,b.jsx)(`span`,{className:`atp-flow-title`,children:n.label}),(0,b.jsx)(`span`,{className:`atp-flow-sub`,children:n.sub})]})]},t))})}if(h)return null;let e=u.length<=2;return(0,b.jsxs)(`div`,{className:`atp-actions`,children:[(0,b.jsx)(`button`,{type:`button`,className:`atp-chip atp-chip--primary`,onClick:()=>{K(`M'aider à souscrire`),v(!0)},children:`M'aider à souscrire`}),x&&(0,b.jsx)(`button`,{type:`button`,className:`atp-chip`,onClick:()=>{K(`Oui, guidez-moi`),v(!0)},children:`Oui, guidez-moi`}),e&&xe.map(e=>(0,b.jsx)(`button`,{type:`button`,className:`atp-chip`,onClick:()=>Ge(e),children:e},e))]})}return(0,ge.createPortal)((0,b.jsxs)(`div`,{className:`atp-root`+(n?` atp-root--lite`:``),children:[J&&(0,b.jsxs)(`div`,{className:`atp-dock`+(je?` atp-dock--away`:ke?` atp-dock--dim`:``),children:[(0,b.jsx)(`button`,{type:`button`,ref:Fe,className:`atp-hint`,"data-show":Oe?``:void 0,"aria-hidden":`true`,tabIndex:-1,onPointerDown:Y,onClick:Y,children:`Besoin d'aide ?`}),(0,b.jsx)(`button`,{type:`button`,ref:Pe,className:`atp-launcher`,"aria-label":`Ouvrir l'assistant Assutempo`,onPointerDown:Y,onClick:Y,children:(0,b.jsx)(g,{name:`bubble`,size:24})})]}),o&&(0,b.jsxs)(`section`,{className:`atp-panel`+(ee?` atp-panel--closing`:``),role:`dialog`,"aria-label":`Assistant Assutempo`,children:[Be&&G&&(0,b.jsxs)(`div`,{"aria-hidden":!0,style:{position:`absolute`,top:6,left:8,right:8,zIndex:50,fontSize:13,fontWeight:700,lineHeight:1.4,color:G.total>1e3?`#ff6b6b`:`#6fcf97`,background:`rgba(0,0,0,0.78)`,padding:`6px 8px`,borderRadius:8,pointerEvents:`none`},children:[`TOTAL `,G.total,` ms`,(0,b.jsx)(`br`,{}),`rendu JS `,G.render,` ms`,(0,b.jsx)(`br`,{}),`paint/compo `,G.paint,` ms`]}),!n&&(0,b.jsxs)(b.Fragment,{children:[(0,b.jsxs)(`div`,{className:`atp-nebula`,"aria-hidden":!0,children:[(0,b.jsx)(`span`,{className:`atp-nebula-blob atp-nebula-blob--gold`}),(0,b.jsx)(`span`,{className:`atp-nebula-blob atp-nebula-blob--violet`}),(0,b.jsx)(`span`,{className:`atp-nebula-blob atp-nebula-blob--deep`})]}),(0,b.jsx)(y.Suspense,{fallback:null,children:(0,b.jsx)(_e,{reduced:R.current,burst:u.length})}),(0,b.jsx)(`div`,{className:`atp-aura`,"aria-hidden":!0})]}),(0,b.jsxs)(`header`,{className:`atp-header`,children:[(0,b.jsx)(`span`,{className:`atp-header-avatar`,children:(0,b.jsx)(ue,{})}),(0,b.jsxs)(`span`,{className:`atp-header-id`,children:[(0,b.jsx)(`span`,{className:`atp-header-name atp-serif`,children:`Tempo`}),(0,b.jsxs)(`span`,{className:`atp-header-status`,children:[(0,b.jsx)(`span`,{className:`atp-status-dot`}),` Concierge Assutempo`]})]}),(0,b.jsx)(`span`,{className:`atp-header-actions`,children:(0,b.jsx)(`button`,{type:`button`,className:`atp-icon-btn`,"aria-label":n?`Fermer l'assistant`:`Réduire l'assistant`,onClick:X,children:(0,b.jsx)(g,{name:n?`close`:`chevron-down`,size:18})})})]}),(0,b.jsxs)(`div`,{className:`atp-messages`,ref:z,"aria-live":`polite`,children:[u.map((e,t)=>(0,b.jsx)(`div`,{className:`atp-row `+(e.role===`user`?`atp-row--user`:`atp-row--bot`),children:(0,b.jsx)(`div`,{className:`atp-bubble `+(e.role===`user`?`atp-bubble--user`:`atp-bubble--bot`),children:e.content})},t)),h&&!ae&&(0,b.jsx)(`div`,{className:`atp-row atp-row--bot`,children:(0,b.jsxs)(`div`,{className:`atp-bubble atp-bubble--bot atp-typing`,"aria-label":`Tempo écrit`,children:[(0,b.jsx)(`span`,{}),(0,b.jsx)(`span`,{}),(0,b.jsx)(`span`,{})]})})]}),nt(),(0,b.jsxs)(`div`,{className:`atp-input-bar`,children:[(0,b.jsx)(`textarea`,{ref:B,className:`atp-input`,rows:1,placeholder:D?`Conversation terminée`:`Posez votre question...`,value:p,onChange:Ke,onKeyDown:qe,disabled:D,"aria-label":`Votre message`}),(0,b.jsx)(`button`,{type:`button`,className:`atp-send`+(C?` atp-send--spark`:``),"aria-label":`Envoyer`,disabled:!p.trim()||h||D,onClick:()=>{Ge(p),B.current&&(B.current.style.height=`auto`)},children:(0,b.jsx)(g,{name:`send`,size:18})})]}),(0,b.jsx)(`p`,{className:`atp-legal`,children:`Assistant indicatif, ne constitue pas un conseil contractuel.`})]}),et()]}),document.body)}var y,ge,b,_e,ve,ye,x,S,C,be,xe,w,Se,Ce,we,Te,T,E,D,O;t((()=>{y=e(r()),ge=e(o()),ee(),u(),f(),l(),re(),b=n(),c(),_e=(0,y.lazy)(()=>a(()=>import(`./CosmosCanvas-CMbUEmbF.js`),__vite__mapDeps([0,1,2]))),ve=`atp-styles`,ye=`Bonjour, je suis Tempo, votre concierge Assutempo. Je réponds à vos questions sur l'assurance auto temporaire et la carte grise, et je peux vous guider pas à pas jusqu'à la souscription. Comment puis-je vous aider ?`,x=`votre numéro dédié, affiché directement dans le tunnel de souscription`,S=`l'équipe au 09 74 19 78 20 (Lun-Ven 9h-21h, Sam 9h-20h)`,C=e=>h(e)?x:S,be=e=>`Je rencontre un souci technique à l'instant. Je peux toutefois vous accompagner pas à pas jusqu'au formulaire, ou vous pouvez joindre ${C(e)}.`,xe=[`Qu'est-ce que l'assurance temporaire ?`,`Quels documents pour rouler ?`,`Assurer un véhicule étranger ?`],w=12,Se=e=>`Vous m'avez déjà posé cette question. Pour un cas précis ou personnalisé, le mieux est de joindre ${C(e)}, ou d'obtenir un devis en ligne.`,Ce=e=>`Pour aller plus loin sur votre situation, contactez ${C(e)}, ou obtenez votre devis en ligne.`,we=ce(10),Te=e=>new Promise(t=>setTimeout(t,e)),T=124,E=`assutempo_consent_v1`,D=`7a4b9f4a-f77e-4f9b-8a16-7635bff791ed`,O=`https://api.web3forms.com/submit`}))();export{v as default};